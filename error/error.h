...
namespace miniplc0 {
	...
	enum ErrorCode {
		...
		ErrStreamError,
		ErrIncompleteBracket,
		ErrIncompleteBrace,
		ErrInvalidVariableDeclaration,
		ErrVoidVariableDeclaration,
		ErrInvalidIdentifier,
		ErrConstantNeedValue,
		ErrNoSemicolon,
		ErrInvalidFunctionDefinition,
		ErrInvalidParameterDeclaration,
		ErrNoReturn,    //有返回值的函数未返回
		ErrNoNeedReturn,   //无返回值的函数返回
		ErrNotFunctionCall,
		ErrInsufficientArguments,  //函数的参数个数不够
